...
<body>
	<div id="header" class="header">
		...
		<div class="subHeader">
		    <div id="subHeaderTitle" class="subHeaderTitle" align="right">Edit - Employee Contact</div>
		</div>
	</div>
	<form method="POST">
		<fieldset>
			...
			<div class="form-row">
				<label for="active">Active:</label> <span class="input"><input
					id="active" name="active" type="checkbox" checked="${employee.active == true ? 'checked' : 'none'}"/>
				</span>
			</div>
			<div class="form-buttons">
	            <div class="button">
					<input type="submit" id="edit" name="_eventId_update" value="Update" />
